...
BehaviourTest3 = TestCase.extend({
	...
	testLinks : function(){
		...
		b.detachListeners(['linkListenerX', 'linkListenerY']);
	...
	testClosures : function(){
		...
		b.detachListeners(['closureListenerX', 'closureListenerY']);
	...
	testClosingReceivers : function(){
		...
		b.detachListeners(['clsRcvListenerX', 'clsRcvListenerY']);
	...
	testClosingDispatchers : function(){
		...
		b.detachListeners(['clsDspvListenerX', 'clsDspListenerY']);
	...
	testTuples : function(){
		...
		b.detachListeners(['tupleListenerX', 'tupleListenerY']);
	...
	testDispatchers : function(){
		...
		b.detachListeners(['dspListenerX', 'dspListenerY']);
	...
	testReceivers : function(){
		...
		b.detachListeners(['rcvListenerX', 'rcvListenerY']);
	...
	testDispatchingReceivers : function(){
		...
		b.detachListeners(['dspRcvListenerX', 'dspRcvListenerY']);
